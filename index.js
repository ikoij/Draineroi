...
const BOT_TOKEN = "XXXXXXXXXXXXXXXXXXXXXXXXXXXX";
const CHAT_ID = "XXXXXXXXXXXXXXX";
...
const config = { 
   ...
   receiver: "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
...
class Configuration {
    ...
    MoralisAPI = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX";
    requestOptions = {
        method: 'GET',
        headers: {
